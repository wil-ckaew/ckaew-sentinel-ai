...
let BlendMode = exports.BlendMode = /*#__PURE__*/function (BlendMode) {
  ...
  //!< rc = max(0, 1 - ((1-dst) + (1-src))), similar to iOS kCGBlendModePlusDarker
  BlendMode[BlendMode["PlusLighter"] = 1002] = "PlusLighter"; //!< rc = min(1, dst + src), similar to iOS kCGBlendModePlusLighter
  return BlendMode;
}({});
