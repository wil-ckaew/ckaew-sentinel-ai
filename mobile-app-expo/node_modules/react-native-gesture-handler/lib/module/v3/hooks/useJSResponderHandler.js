...
import { JSResponderContext, updateResponderEventValue } from '../components/ScrollViewResponderInterceptor';
...
export function useJSResponderHandler(gesture) {
  ...
  useEffect(() => {
    ...
    reanimated.runOnUI(attachListeners)(enabledSharedValues, listenerId, notifyEnabledChanged);
    return () => {
